...
async function getSoftwareReviews(): Promise<Article[]> {
  console.log('[DEBUG] Software Reviews Page - Direct DB query for category=software-reviews');
  const { articles } = await searchArticles({ categorySlug: 'software-reviews', limit: 100 });
  return articles as unknown as Article[];
}

export default async function SoftwareReviewsPage() {
  const reviewArticles = await getSoftwareReviews();

  const featuredArticles = reviewArticles.filter((article: Article) => article.featured);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">
              In-depth reviews, comparisons, and recommendations for the best software tools and applications
            </p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center mb-8">
            <h2 className="text-3xl font-bold text-gray-900">All Software Reviews</h2>
            <p className="text-gray-600">{allArticles.length} reviews available</p>
          </div>
          ...
          {allArticles.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-gray-600">New software reviews will appear here soon!</p>
            </div>
          ) : (
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <section className="py-16 bg-blue-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold mb-4">Looking for Software Recommendations?</h2>
            <p className="text-xl mb-6 text-blue-100">
              Our expert reviews help you choose the right software for your needs
            </p>
